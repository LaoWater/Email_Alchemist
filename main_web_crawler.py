...
def open_page(driver):
    ...
    find_and_click(
        driver,
        outer_html='<button class="btn relative btn-primary btn-small" as="button" data-testid="mobile-login-button"><div class="flex items-center justify-center">Log in</div></button>',  # Provide the actual outerHTML here
